...
public class ContinueLevelBtnListener extends InputListener {
    private Pathfinder game;
    public ContinueLevelBtnListener(Pathfinder game) {
        this.game = game;
    }

    @Override
    public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
        log("continue level button pressed");
        game.screenManager.pauseScreen.onClose();
        game.setScreen(game.screenManager.levelScreen);
        game.screenManager.levelScreen.resume();
