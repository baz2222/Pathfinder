...
public class ContinueGameBtnListener extends InputListener {
    private Pathfinder game;
    public ContinueGameBtnListener(Pathfinder game) {
        this.game = game;
    }

    @Override
    public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
        Pathfinder.log("continue game button pressed");
        game.stateManager.loadState();
