...
public class TasksBtnListener extends InputListener {
    private Pathfinder game;
    public TasksBtnListener(Pathfinder game) {
        this.game = game;
    }

    @Override
    public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
        log("tasks button pressed");
        game.screenManager.menuScreen.onClose();
        game.setScreen(game.screenManager.tasksScreen);
