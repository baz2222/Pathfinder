...
public class SelectLevelBtnListener extends InputListener {
    private Pathfinder game;
    private int level;
    public SelectLevelBtnListener(Pathfinder game, int level) {
        this.game = game;
        this.level = level;
    }
    ...
    public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
        log("select level button pressed");
        game.currLevel = level;
        game.screenManager.selectLevelScreen.onClose();
