...
public class PauseBtnListener extends InputListener {
    private Pathfinder game;
    public PauseBtnListener(Pathfinder game) {
        this.game = game;
    }
    ...
    public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
        ...
        ((GameScreen)game.getScreen()).pause();
        game.setScreen(game.screenManager.pauseScreen);
