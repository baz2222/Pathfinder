...
public class TasksBackBtnListener extends InputListener {
    private Pathfinder game;
    public TasksBackBtnListener(Pathfinder game) {
        this.game = game;
    }

    @Override
    public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
        log("tasks back button pressed");
        game.screenManager.tasksScreen.onClose();
