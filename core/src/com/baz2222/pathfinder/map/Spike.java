...
public class Spike extends Actor {
    ...
    public Spike(Pathfinder game, String name) {
        this.game = game;
        setName(name);
        bodyDef = new BodyDef();
        ...
        fixtureDef.filter.maskBits = (short) (game.box2DManager.playerBit);
        fixtureDef.filter.categoryBits = game.box2DManager.spikeBit;
