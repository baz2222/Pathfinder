...
public class SelectLevelScreen extends GameScreen {
    ...
    public SelectLevelScreen(Pathfinder game) {
        this.game = game;
    }
    ...
    public void onOpen() {
        ...
        game.uiManager.createSelectLevelTable();
        log("select level screen created");
    }
    ...
    public void onClose() {
        ...
        game.uiManager.removeSelectLevelTable();
        game.mapManager.unloadLevelMap();
        log("select level screen closed");
    }
